import productiveLogo from "../assets/PD-Logo_Stack-removebg-preview 1 (2).png";
        ...
        <table className="w-full text-sm text-left min-w-[600px] sm:min-w-full">
          <thead>
            <tr className="bg-gray-100">
              <th className="py-3 px-3 sm:px-4 font-medium text-gray-700">
                Institutes
              </th>
              <th className="py-3 px-3 sm:px-4 font-medium text-gray-600">
                Date joined
              </th>
              <th className="py-3 px-3 sm:px-4 font-medium text-gray-600">
                Status
            ...
            {institutes.map((inst, index) => (
              <tr key={index} className="hover:bg-gray-50">
                ...
                <td className="py-2 sm:py-3 px-2 sm:px-4">
                  <span
                    className={`px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium ${statusStyles[inst.status]}`}
                  >
                    {inst.status}
                  </span>
                </td>
